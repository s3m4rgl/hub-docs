...
DomainScope тоже работает с NetBox (импорт целей сканирования + экспорт обнаруженных IP). См. [`domainscope-netbox.md`](domainscope-netbox.md).
...
Подробнее: [`domainscope-netbox.md`](domainscope-netbox.md).
...
- [`domainscope-netbox.md`](domainscope-netbox.md) — sync с DomainScope
