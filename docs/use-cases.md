...
Каналы уведомлений — нативные плагины, поэтому источнику каталога нужно
разрешение на исполнение нативных плагинов; провайдерам задач оно не нужно —
им нативный режим запрещён.
