...
| Учёт задач | Чтобы работа попадала исполнителю — Jira, GitHub Issues или Trello | [Официальные плагины](plugins-official.md), [Интеграция с Jira](integration-jira.md) |
