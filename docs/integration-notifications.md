...
!!! warning "С 0.33 доставку ведут плагины"
    ...
    нативные (Tier 2), поэтому источнику каталога нужно разрешение на
    исполнение нативных плагинов; без него плагин виден в каталоге и не
    ставится. Сначала установите плагин — см. [Плагины](plugins.md), — и
...
| `TELEGRAM_NOTIFICATION_WORKERS` | Параллелизм очереди Telegram | `5` |
...
Переменные `MATTERMOST_NOTIFICATION_WORKERS` и `MAXRU_NOTIFICATION_WORKERS`
**удалены в 0.33** вместе с очередями, которыми они управляли; оставленные в
конфигурации значения не читаются.
